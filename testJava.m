...
calibCoeffsLM = javaMethod('getLMFit',javaClass);  %With weights

[calibCoeffs'; calibCoeffsw';calibCoeffsLM']
...
disp(sprintf('Coeffs with JavaLM x %.3f %.3f y %.3f %.3f z %.3f %.3f orig e %.3f calib e %.3f',calibCoeffsLM(1),calibCoeffsLM(2),calibCoeffsLM(3),calibCoeffsLM(4),calibCoeffsLM(5),calibCoeffsLM(6),sqrt(sum((origRes-1).^2)),sqrt(sum((calibResLM-1).^2))));
